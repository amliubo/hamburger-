  ...
  <el-scrollbar height="100vh">
    ...
    <div class="container">
        ...
        formatTime(activity.time)
              ...
              <div class="right-section">
                ...
                <el-collapse v-show="showContent === activity._id" class="comment-collapse">
                  <p />
                  <el-link :underline="false" size="small" type="info" :style="{ fontSize: '12px', marginLeft: 'auto' }"
                    @click="toggleContent">
                    <el-icon>
                      <Top />
                    </el-icon>
                  ...
                  <div v-for="(com, index) in activity.comment" :key="com._id" class="comment-container">
                    <div class="comment-info">
                      <div class="name-and-time">
                        ...
                        <span>&nbsp;</span>
                        <div class="time">
                          <el-text style="font-size: 12px; color: '#909399">{{
        com.address
      }}
                          </el-text>
                        </div>
      ...
      <div v-show="activeIndex === '2'">
        <iframe src="http://ethanliu.top:8080/" style="width: 100%; height: 100%; border: none;"></iframe>
      </div>
...
export default {
  ...
  components: { alert: Alert, Footer, NumberGuessingGame, LoginForm },
  methods: {
    handleSelect(index) {
